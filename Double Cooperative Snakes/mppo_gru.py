...
class ActorCritic(nn.Module):
    def __init__(self, height=10, width=10, hidden_dim=128, action_dim=4, num_agents=2):
        ...
        # GRU takes the input as (batch_size, seq_length, input_dim)
        self.gru_input_size = height * width  # The input for each time step (flattened)
    ...
    def pi(self, x):
        ...
        # Reshape input for GRU: (batch_size, seq_length, input_size)
        x = x.view(batch_size, -1, self.gru_input_size)
